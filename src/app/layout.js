...
export const metadata = {
  ...
  other: {
    keywords: 'cuenta horizonte, cuenta de ahorros, lafise honduras, banca personal, solicitar cuenta, intereses altos, ahorro inteligente'
  }
}
...
export default function RootLayout(props) {
  ...
  return (
    <html lang="es">
      ...
      <body>
        {env !== 'development'&& <Header filename={headerName} />}
        {props.children}
        {env !== 'development' && <Footer filename={footerName} />}
        <Script
          id="popper"
