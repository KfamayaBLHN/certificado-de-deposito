...
if ( process.env.NODE_ENV !== 'development' ) {
  _assetPrefix = '/blh/banca-personal/certificado_deposito/v1.0.0/';
  _basePath = '/blh/banca-personal/certificado_deposito/v1.0.0';
  _publicBasePath = '/blh/banca-personal/certificado_deposito/v1.0.0';//es el path para las imagenes
}
