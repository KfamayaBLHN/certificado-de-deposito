...
if ( process.env.NODE_ENV !== 'development' ) {
  _assetPrefix = '/blh/banca-personal/certificado_deposito/v1.0.1/';
  _basePath = '/blh/banca-personal/certificado_deposito/v1.0.1';
  _publicBasePath = '/blh/banca-personal/certificado_deposito/v1.0.1';//es el path para las imagenes
}
